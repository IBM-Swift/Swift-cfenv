...
## Swift version
The latest version of Swift-cfenv works with the `Swift 4.0.3` or newer. You can download this version of the Swift binaries by following this [link](https://swift.org/download/#snapshots).
